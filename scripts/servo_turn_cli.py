...
def main(argv: Optional[list] = None):
    ...
    parser.add_argument('--speed', type=float, default=20.0, help='Turning speed in deg/s')
    parser.add_argument('--interval', type=int, default=50, help='Step interval ms (granularity of smooth move)')
